...
<template>
  ...
  <liu-alert title="不可关闭的 alert" type="success" :closable="false" effect="dark"></liu-alert>
  <liu-alert title="自定义 close-text" type="info" close-text="知道了" effect="dark"></liu-alert>
  <liu-alert title="设置了回调的 alert" type="warning" @close="hello" effect="dark"></liu-alert>
</template>
